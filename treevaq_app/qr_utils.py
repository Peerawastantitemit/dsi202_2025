# dsi202/my_django_project/treevaq_app/qr_utils.py

# -*- coding: utf-8 -*-
"""
Generates and displays Thai PromptPay QR codes.
"""
import libscrc
...
def generate_promptpay_qr_payload(
    ...
    if mobile:
        ...
        if not (len(mobile_cleaned) == 10 and mobile_cleaned.isdigit()):
            raise InvalidInputError("Mobile number must be a 10-digit string (e.g., '0822154560').")
...
# This function is for Jupyter Notebook, we'll adapt it for Django views
